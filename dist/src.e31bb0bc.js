...
function title(block) {
  return (0, _utils.row)((0, _utils.col)("<h1>".concat(block.value, "</h1>"))); // return `
  //     <div class="row">
  //         <div class="col-sm">
  //             <h1>${block.value}</h1>
  //         </div>
...
function text(block) {
  return (0, _utils.row)((0, _utils.col)("<p>".concat(block.value, "</p>"))); // return `
  //     <div class="row">
  //         <div class="col-sm">
  //             <h1>${block.value}</h1>
  //         </div>
...
function columns(block) {
  ...
  return (0, _utils.row)(html); //    return `<div class="row">${html.join("")}</div>`
}

function image(block) {
  return (0, _utils.row)("<img src=\"".concat(block.value, "\">")); //    return `<div class="row"><img src="${block.value}"></div>`
...
console.log(_templates.templates.title({
  value: 'title'
}));
...
},{"./styles/main.css":"styles/main.css","./model":"model.js","./templates":"templates.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
